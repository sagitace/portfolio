  ...
  return (
    <div
      className={`sticky top-0 z-10 backdrop-filter ${
        scrolling ? "backdrop-blur-md drop-shadow-lg shadow-lg" : "0"
    ...
    >
      <nav className="flex justify-between items-center h-[60px] max-w-[1240px] mx-auto px-4 text-[#edf2f4]">
        ...
        <div
          className={`fixed left-0 top-0 w-[100%] h-full border-r-gray-900 bg-[#2b2d42] ease-in-out duration-500 block md:hidden overflow-hidden z-[10] ${
            !nav ? "" : "left-[-100%]"
          }`}
        >
