    ...
    <div className="mx-auto">
      <Slide up>
        <header className="flex flex-col items-center text-center">
          <h1 className="font-bold text-4xl mb-[55px] text-transform: uppercase after:mx-auto after:mb-0 after:block after:mt-5 after:rounded-full after:h-1 after:w-28 after:-translate-y-1 after:bg-red-600 text-[#edf2f4]">
            Get in touch
          </h1>
        </header>
      </Slide>
