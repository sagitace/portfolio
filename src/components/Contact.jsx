...
const Contact = () => {
    return (
        <div className="mx-auto">
           ...
           <div class="relative flex items-top sm:items-center sm:pt-0">
                    <div class="max-w-full mx-auto px-2 sm:px-6 lg:px-8 w-[1000px]">
                        <div class="mt-8 overflow-hidden w-full">
                            <div class="grid grid-cols-1 md:grid-cols-2 p-6 mr-2 bg-gray-800 sm:rounded-xl rounded-xl w-full">
                                <div>
                                
                                    <p class="text-normal text-lg sm:text-2xl font-medium text-gray-600 dark:text-gray-400 mt-2 text-left">
                                    ...
                                    <div class="flex items-center mt-8 text-gray-600 dark:text-gray-400">
                                        ...
                                        <div class="ml-4 text-md tracking-wide font-semibold w-full text-left">
                                    ...
                                    <div class="flex items-center mt-4 text-gray-600 dark:text-gray-400">
                                        ...
                                        <div class="ml-4 text-left text-md tracking-wide font-semibold w-56">
                                    ...
                                    <div class="flex items-center mt-4 text-gray-600 dark:text-gray-400">
                                        ...
                                        <div class="ml-4 text-md tracking-wide font-semibold w-56 text-left">
                                            <a href="mailto:aaronbarlas.labini@gmail.com">aaronbarlas.labini@gmail.com</a>
                                        </div>
                                    </div>
                                </div>
                                <div className="animate-fade-up animate-once animate-delay-[600ms] animate-ease-in-out flex justify-center items-center">
